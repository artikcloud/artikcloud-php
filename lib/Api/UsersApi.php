...
class UsersApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->createUserPropertiesWithHttpInfo ($user_id, $properties, $aid);
        return $response; 
    }
    ...
    public function createUserPropertiesWithHttpInfo($user_id, $properties, $aid = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\ArtikCloud\Model\PropertiesEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\PropertiesEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\PropertiesEnvelope', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->deleteUserPropertiesWithHttpInfo ($user_id, $aid);
        return $response; 
    }


    /**
     * deleteUserPropertiesWithHttpInfo
     *
     * Delete User Application Properties
     *
     * @param string $user_id User Id (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getSelfWithHttpInfo ();
        return $response; 
    }
    ...
    public function getSelfWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\ArtikCloud\Model\UserEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\UserEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\UserEnvelope', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getUserDeviceTypesWithHttpInfo ($user_id, $offset, $count, $include_shared);
        return $response; 
    }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getUserDevicesWithHttpInfo ($user_id, $offset, $count, $include_properties);
        return $response; 
    }


    /**
     * getUserDevicesWithHttpInfo
     *
     * Get User Devices
     *
     * @param string $user_id User ID (required)
    ...
    public function getUserDevicesWithHttpInfo($user_id, $offset = null, $count = null, $include_properties = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\ArtikCloud\Model\DevicesEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\DevicesEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\DevicesEnvelope', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getUserPropertiesWithHttpInfo ($user_id, $aid);
        return $response; 
    }
     ...
     * @param bool $other_applications List rules of other applications if current application id has full read access (optional)
     * @param int $count Desired count of items in the result set. (optional)
     * @param int $offset Offset for pagination. (optional)
     * @return \ArtikCloud\Model\RulesEnvelope
     * @throws \ArtikCloud\ApiException on non-2xx response
     */
    public function getUserRules($user_id, $exclude_disabled = null, $other_applications = null, $count = null, $offset = null)
    {
        list($response, $statusCode, $httpHeader) = $this->getUserRulesWithHttpInfo ($user_id, $exclude_disabled, $other_applications, $count, $offset);
        return $response; 
    }


    /**
     * getUserRulesWithHttpInfo
     *
     * Get User Rules
     *
     * @param string $user_id User ID. (required)
     ...
     * @throws \ArtikCloud\ApiException on non-2xx response
     */
    public function getUserRulesWithHttpInfo($user_id, $exclude_disabled = null, $other_applications = null, $count = null, $offset = null)
    {
        ...
        if ($other_applications !== null) {
            $queryParams['otherApplications'] = $this->apiClient->getSerializer()->toQueryValue($other_applications);
        }// query params
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\ArtikCloud\Model\RulesEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\RulesEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\RulesEnvelope', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateUserPropertiesWithHttpInfo ($user_id, $properties, $aid);
        return $response; 
    }
