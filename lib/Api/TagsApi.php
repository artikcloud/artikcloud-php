...
class TagsApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getTagCategoriesWithHttpInfo ();
        return $response; 
    }
    ...
    public function getTagCategoriesWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\ArtikCloud\Model\TagsEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\TagsEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\TagsEnvelope', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getTagSuggestionsWithHttpInfo ($entity_type, $tags, $name, $count);
        return $response; 
    }


    /**
     * getTagSuggestionsWithHttpInfo
     *
     * Get tag suggestions
     *
     * @param string $entity_type Entity type name. (optional)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getTagsByCategoriesWithHttpInfo ($categories);
        return $response; 
    }


    /**
     * getTagsByCategoriesWithHttpInfo
     *
     * Get all tags of categories
     *
     * @param string $categories Comma separated list of categories. (optional)
