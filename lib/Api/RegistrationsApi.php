...
class RegistrationsApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->confirmUserWithHttpInfo ($registration_info);
        return $response; 
    }


    /**
     * confirmUserWithHttpInfo
     *
     * Confirm User
     *
     * @param \ArtikCloud\Model\DeviceRegConfirmUserRequest $registration_info Device Registration information. (required)
    ...
    public function confirmUserWithHttpInfo($registration_info)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\ArtikCloud\Model\DeviceRegConfirmUserResponseEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\DeviceRegConfirmUserResponseEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\DeviceRegConfirmUserResponseEnvelope', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getRequestStatusForUserWithHttpInfo ($request_id);
        return $response; 
    }


    /**
     * getRequestStatusForUserWithHttpInfo
     *
     * Get Request Status For User
     *
     * @param string $request_id Request ID. (required)
    ...
    public function getRequestStatusForUserWithHttpInfo($request_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\ArtikCloud\Model\DeviceRegStatusResponseEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\DeviceRegStatusResponseEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\DeviceRegStatusResponseEnvelope', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->unregisterDeviceWithHttpInfo ($device_id);
        return $response; 
    }
    ...
    public function unregisterDeviceWithHttpInfo($device_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'DELETE',
                $queryParams, $httpBody,
                $headerParams, '\ArtikCloud\Model\UnregisterDeviceResponseEnvelope'
            );
            ...
            return array(\ArtikCloud\ObjectSerializer::deserialize($response, '\ArtikCloud\Model\UnregisterDeviceResponseEnvelope', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = \ArtikCloud\ObjectSerializer::deserialize($e->getResponseBody(), '\ArtikCloud\Model\UnregisterDeviceResponseEnvelope', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
