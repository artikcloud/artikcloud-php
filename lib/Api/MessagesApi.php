...
class MessagesApi
{
    ...
    public function getAggregatesHistogramWithHttpInfo($start_date, $end_date, $sdid = null, $field = null, $interval = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\AggregatesHistogramResponse',
                '/messages/analytics/histogram'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\AggregatesHistogramResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\AggregatesHistogramResponse', $e->getResponseHeaders());
    ...
    public function getFieldPresenceWithHttpInfo($start_date, $end_date, $interval, $sdid = null, $field_presence = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\FieldPresenceEnvelope',
                '/messages/presence'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\FieldPresenceEnvelope', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\FieldPresenceEnvelope', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function getLastNormalizedMessagesWithHttpInfo($count = null, $sdids = null, $field_presence = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\NormalizedMessagesEnvelope',
                '/messages/last'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\NormalizedMessagesEnvelope', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\NormalizedMessagesEnvelope', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function getMessageAggregatesWithHttpInfo($sdid, $field, $start_date, $end_date)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\AggregatesResponse',
                '/messages/analytics/aggregates'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\AggregatesResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\AggregatesResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \ArtikCloud\Model\SnapshotResponses
     * @throws \ArtikCloud\ApiException on non-2xx response
     */
     ...
     * @param string $sdids Device IDs for which the snapshots are requested. Max 100 device ids per call. (required)
     * @param bool $include_timestamp Indicates whether to return timestamps of the last update for each field. (optional)
     * @return Array of \ArtikCloud\Model\SnapshotResponses, HTTP status code, HTTP response headers (array of strings)
     * @throws \ArtikCloud\ApiException on non-2xx response
     */
    public function getMessageSnapshotsWithHttpInfo($sdids, $include_timestamp = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\SnapshotResponses',
                '/messages/snapshots'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\SnapshotResponses', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\SnapshotResponses', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
