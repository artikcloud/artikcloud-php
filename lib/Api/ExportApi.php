    ...
    public function exportRequestWithHttpInfo($export_request_info)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\ExportRequestResponse',
                '/messages/export'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\ExportRequestResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\ExportRequestResponse', $e->getResponseHeaders());
    ...
    public function getExportHistoryWithHttpInfo($trial_id = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\ExportHistoryResponse',
                '/messages/export/history'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\ExportHistoryResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\ExportHistoryResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function getExportStatusWithHttpInfo($export_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\ExportStatusResponse',
                '/messages/export/{exportId}/status'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\ExportStatusResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\ExportStatusResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
