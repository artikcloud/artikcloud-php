...
class DevicesApi
{
    ...
    public function addDeviceWithHttpInfo($device)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\DeviceEnvelope',
                '/devices'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\DeviceEnvelope', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\DeviceEnvelope', $e->getResponseHeaders());
    ...
    public function deleteDeviceTokenWithHttpInfo($device_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\DeviceTokenEnvelope',
                '/devices/{deviceId}/tokens'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\DeviceTokenEnvelope', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\DeviceTokenEnvelope', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \ArtikCloud\Model\PresenceEnvelope
     * @throws \ArtikCloud\ApiException on non-2xx response
     */
     ...
     *
     * @param string $device_id Device ID. (required)
     * @return Array of \ArtikCloud\Model\PresenceEnvelope, HTTP status code, HTTP response headers (array of strings)
     * @throws \ArtikCloud\ApiException on non-2xx response
     */
    public function getDevicePresenceWithHttpInfo($device_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\ArtikCloud\Model\PresenceEnvelope',
                '/devices/{deviceId}/presence'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\ArtikCloud\Model\PresenceEnvelope', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\ArtikCloud\Model\PresenceEnvelope', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
