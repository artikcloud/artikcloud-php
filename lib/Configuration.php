 ...
 * @category Class
 * @package  ArtikCloud
 * @author   ARTIK Cloud Team
 * @link     https://github.com/artikcloud/artikcloud-php
 */

/**
 * ARTIK Cloud API
 *
 * This SDK helps you connect your PHP scripts to ARTIK Cloud. 
 * The SDK exposes a number of methods to easily execute REST API calls to ARTIK Cloud.
 *
 * https://github.com/artikcloud/artikcloud-php
 *
 */
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.artik.cloud/v1.1';
    ...
    {
        $report  = 'PHP SDK (ArtikCloud) Debug Report:' . PHP_EOL;
