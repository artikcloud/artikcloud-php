 ...
 * @category Class
 * @package  ArtikCloud
 * @author   ARTIK Cloud Evangelism
 * @link     https://developer.artik.cloud
 */
 ...
 * 
 * Generated by: https://github.com/artikcloud/artikcloud-php
 *
 */
...
class ApiClient
{
     ...
     */
    public function __construct(\ArtikCloud\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \ArtikCloud\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\ArtikCloud\ObjectSerializer::sanitizeForSerialization($postData));
        }
