 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpgradePath implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpgradePath';
    ...
    /**
     * Sets url
     * @param string $url Url to display the upgrade path to the user
     * @return $this
     */
