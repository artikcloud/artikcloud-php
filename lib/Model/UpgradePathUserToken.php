...
/**
 * UpgradePathUserToken Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ArtikCloud
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpgradePathUserToken implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpgradePathUserToken';
    ...
    /**
     * Sets access_token
     * @param string $access_token User token from initial upgrade path request
     * @return $this
     */
