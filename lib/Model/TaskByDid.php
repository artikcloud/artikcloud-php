...
class TaskByDid implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'property' => 'string',
        'statuses' => '\ArtikCloud\ArtikCloud\Model\DeviceTask[]',
        'id' => 'string',
        'dids' => 'string[]',
    ...
    /**
     * Gets statuses
     * @return \ArtikCloud\ArtikCloud\Model\DeviceTask[]
     */
    ...
    /**
     * Sets statuses
     * @param \ArtikCloud\ArtikCloud\Model\DeviceTask[] $statuses Last known device task status for the specified did
     * @return $this
     */
