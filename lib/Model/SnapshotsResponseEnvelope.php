...
/**
 * SnapshotsResponseEnvelope Class Doc Comment
 *
 * @category    Class */
 // @description 
/** 
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SnapshotsResponseEnvelope implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SnapshotsResponseEnvelope';
    ...
    protected static $swaggerTypes = array(
        'data' => '\ArtikCloud\Model\SnapshotResponses',
        'sdid' => 'string'
    );
    ...
    /**
     * Sets data
     * @param \ArtikCloud\Model\SnapshotResponses $data
     * @return $this
     */
