 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Whitelist implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Whitelist';
    ...
    {
        $this->container['vdid'] = isset($data['vdid']) ? $data['vdid'] : null;
    ...
    {
        return $this->container['vdid'];
    }

    /**
     * Sets vdid
     * @param string $vdid VendorDeviceId
     * @return $this
     */
    public function setVdid($vdid)
    {
        $this->container['vdid'] = $vdid;
    ...
    /**
     * Sets uploaded_on
     * @param int $uploaded_on Uploaded on
     * @return $this
     */
