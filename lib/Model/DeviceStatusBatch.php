...
/**
 * DeviceStatusBatch Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ArtikCloud
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DeviceStatusBatch implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeviceStatusBatch';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'offset' => 'int',
        'data' => '\ArtikCloud\ArtikCloud\Model\DeviceStatus[]',
        'count' => 'int'
    ];
    ...
    /**
     * Sets data
     * @param \ArtikCloud\ArtikCloud\Model\DeviceStatus[] $data
     * @return $this
     */
