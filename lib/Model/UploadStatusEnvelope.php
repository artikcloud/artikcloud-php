...
/**
 * UploadStatusEnvelope Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     ArtikCloud
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UploadStatusEnvelope implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UploadStatusEnvelope';
    ...
    /**
     * Sets status
     * @param string $status The uploaded CSV status, like 'Processing', 'Completed' or 'Failed'
     * @return $this
     */
